...
import com.example.calculadorajava.core.calculateFactorial;
import com.example.calculadorajava.core.doubleEvaluator;
import com.example.calculadorajava.core.helper;

public class CientificActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cientific);
        ...
        switch (v.getId()) {
                ...
                if (e2.length() != 0) {
                    ...
                    else
                    {
                        ...
                        try
                        {
                            ...
                            int []arr=cf.factorial((int)Double.parseDouble(String.valueOf(new doubleEvaluator().evaluate(text))));
            ...
            case R.id.sin:
                if (e2.length() != 0) {
                    ...
                    if(angleMode==1)
                    {
                        double angle=Math.toRadians(new doubleEvaluator().evaluate(text));
                        if(toggleMode==1)
